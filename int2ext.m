function [gen,bus,Lnbr,trsfm,shtc,shtr,vctr] = int2ext(i2e, gen,bus,Lnbr,trsfm,shtc,shtr,vctr,sysdt,loss)
...
head =['                                                                                                                              '
       '   LnBR.  Bus   Bus    R      X    1/2 B      Power Flow        Power Flow           Loss          VolMag   VolMag    Switch  '
       '    NO.  from   to    p.u.   p.u.   p.u.        f to t            t to f             p.u.            f        t       Status  '
       '                                                                                                                              '];
disp(head)
...
for i = 1:size(Lnbr,1)
    ...
    fprintf(' %8.3f', Lnbr(i,11)), fprintf(' %8.3f', Lnbr(i,12)),fprintf(' %8.3f\n', 1)
end
fprintf('      \n'), fprintf('    Total                                ')
