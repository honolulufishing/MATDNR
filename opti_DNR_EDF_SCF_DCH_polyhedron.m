...
nfixed_switch = length(find(Lnbr_all(:,7)==2));
...
A_auxiliary_1 = zeros(nLnbr,2*nLnbr+nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+4*nLnbr);
for i = 1 :nLnbr
...
A_auxiliary_2 = zeros(nLnbr,2*nLnbr+nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+4*nLnbr);
for i = 1 : nLnbr
...
A_I = zeros(nLnbr,2*nLnbr+nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+4*nLnbr);
for i = 1 : nLnbr
...
U_var = zeros(nLnbr,2*nLnbr+nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+4*nLnbr);
b_var = zeros(nLnbr,1);
for i = 1 :nLnbr
    ...
    if Lnbr_all(i,7)~= 2
        U_var(i,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+i)  =-1;  % y1
...
S_max = nb;
A_f_u_1 =zeros(nLnbr,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+4*nLnbr);
A_f_u_2 =zeros(nLnbr,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+4*nLnbr);
for i = 1: nLnbr
    A_f_u_1(i,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+i) = 1;
    A_f_u_2(i,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+i) = 1;
end
A_f_u_1(:,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+3*nLnbr+1:3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+4*nLnbr)=-S_max*diag(ones(1,nLnbr));
A_f_u_2(:,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+3*nLnbr+1:3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+4*nLnbr)=S_max*diag(ones(1,nLnbr));

A_beta_1 = zeros(nLnbr,2*nLnbr+nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+4*nLnbr);
for i = 1:nLnbr
    A_beta_1(i,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+nLnbr+(i-1)*2+1:3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+nLnbr+2*i) =[1 1];
    A_beta_1(i,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+3*nLnbr+i) =-1;
end
...
A_beta = [zeros(nb,nLnbr+nLnbr+nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr) A_f zeros(nb,3*nLnbr);
    A_beta_1 ;
    zeros(n_source,nLnbr+nLnbr+nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+nLnbr) A_beta_2 zeros(n_source,nLnbr);
    zeros(2*n_ex,nLnbr+nLnbr+nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+nLnbr) A_beta_3 zeros(2*n_ex,nLnbr);
    zeros(nb-1,nLnbr+nLnbr+nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+nLnbr) A_beta_4 zeros(nb-1,nLnbr);
    zeros(1,nLnbr+nLnbr+nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+nLnbr+2*nLnbr) A_radiality;
    ];
...
Aeq_modify = [ (1/2).*A_P_reduced       zeros(nb-1,nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr)       zeros(nb-1,nLnbr*4);
    (1/2).*A_Q_reduced       zeros(nb-1,nb)    A_UQG A_SHTC  zeros(nb-1,2*nLnbr+2*nLnbr+nLnbr+nLnbr+nLnbr*4);
    A_beta ;
    A_I;
    A_auxiliary_1;
    A_auxiliary_2;
...
n_approx = 30;  % 30
phy = 2*pi/n_approx;
A_s_upper = zeros(n_approx*nLnbr,nLnbr+nLnbr+nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+4*nLnbr);
b_s_upper = zeros(n_approx*nLnbr,1);
for i = 1 : nLnbr
    for j = 1 : n_approx
         A_s_upper((i-1)*n_approx+j,i) = cos((j-1)*phy);  % first SOC constraints
         A_s_upper((i-1)*n_approx+j,nLnbr+i) = sin((j-1)*phy);
         A_s_upper((i-1)*n_approx+j,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+i) =  -1 ; 
    end
end

A_s_lower = zeros(n_approx*nLnbr,nLnbr+nLnbr+nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+4*nLnbr);
b_s_lower = zeros(n_approx*nLnbr,1);
for i = 1 : nLnbr
    for j = 1 : n_approx
        
        A_s_lower((i-1)*n_approx+j,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+i) = cos((j-1)*phy);   % second SOC constraints
        A_s_lower((i-1)*n_approx+j,3*nLnbr+nb+npv+nshtc+nLnbr+i) = sin((j-1)*phy);
        A_s_lower((i-1)*n_approx+j,3*nLnbr+nb+npv+nshtc+i) = -1;
...
%---------Perspective cuts for P and Q-----%
A_P = zeros(nLnbr,nLnbr+nLnbr+nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+4*nLnbr);
A_Q = zeros(nLnbr,nLnbr+nLnbr+nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+4*nLnbr);
A_y_3 = zeros(nLnbr,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+4*nLnbr);
for i = 1 : nLnbr
    if Lnbr_all(i,7)~= 2
        if    atan(Lnbr_all(i,4)/Lnbr_all(i,5)) <= pi/2 &&  atan(Lnbr_all(i,4)/Lnbr_all(i,5)) >= -pi/2
            
            A_P(i,i) = 1;
            A_P(i,nLnbr+nLnbr+nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+nLnbr+2*i) = -10;
            
            A_Q(i,nLnbr+i) =  1;
            A_Q(i,nLnbr+nLnbr+nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+nLnbr+2*i) = -10;
            
            A_y_3(i,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+i) = 1;
           A_y_3(i,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+nLnbr+2*i) = -(bus(Lnbr_all(i,2),10).^2 - bus(Lnbr_all(i,3),9).^2);

        elseif   atan(Lnbr_all(i,4)/Lnbr_all(i,5)) >= pi/2 &&   atan(Lnbr_all(i,4)/Lnbr_all(i,5)) <= - pi/2
            
            A_P(i,i) =  -1;
            A_P(i,nLnbr+nLnbr+nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+nLnbr+2*i-1) = -10;
            
            A_Q(i,nLnbr+i) =  -1;
            A_Q(i,nLnbr+nLnbr+nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+nLnbr+2*i-1) = -10;
            
            A_y_3(i,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+i) = -1;
           A_y_3(i,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+nLnbr+2*i-1) = -(bus(Lnbr_all(i,2),10).^2 - bus(Lnbr_all(i,3),9).^2);
        end
    end
end
% ------End-----------%

%-------Perspective cuts for for y1-----------%
A_y_1 = zeros(nLnbr,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+4*nLnbr);
A_y_2 = zeros(nLnbr,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+4*nLnbr);
...
for i = 1 : nLnbr
    if Lnbr_all(i,7)~= 2
        ...
        A_y_1(i,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+i) = 1;
        A_y_1(i,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+3*nLnbr+i) =-( bus(Lnbr_all(i,2),10).^2 - bus(Lnbr_all(i,3),9).^2);
        ...
        A_y_2(i,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+i) = 1;
        A_y_2(i,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+3*nLnbr+i) = -(bus(Lnbr_all(i,2),9).^2 - bus(Lnbr_all(i,3),10).^2);
        b_y_2(i,1) = -(bus(Lnbr_all(i,2),9).^2 - bus(Lnbr_all(i,3),10).^2);
    end
end
% ------End-----------%

A_I_u_1 =zeros(nLnbr,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+4*nLnbr);
A_I_u_2 =zeros(nLnbr,3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+4*nLnbr);
for i = 1: nLnbr
    A_I_u_1(i,3*nLnbr+nb+npv+nshtc+2*nLnbr+i) = 1;
    A_I_u_1(i,3*nLnbr+nb+npv+nshtc+2*nLnbr+nLnbr+2*nLnbr+nLnbr+nLnbr+2*i)=-S_max;
    
    A_I_u_2(i,3*nLnbr+nb+npv+nshtc+2*nLnbr+nLnbr+i) = 1;
    A_I_u_2(i,3*nLnbr+nb+npv+nshtc+2*nLnbr+nLnbr+2*nLnbr+nLnbr+nLnbr+2*i-1)=-S_max;
end


% Linear Constraints of QG ranged between lower and upper boundaries
A_QGSW_inequal =  [zeros(1,nLnbr) 1 zeros(1,nLnbr-1) zeros(1,nLnbr) zeros(1,nb) zeros(1,npv) zeros(1,nshtc) zeros(1,2*nLnbr+2*nLnbr+nLnbr+nLnbr) zeros(1,4*nLnbr)];
...
% Bounds
lb = [-100.*ones(1,2*nLnbr) zeros(1,nLnbr) (bus(:,9).^2)' gen(2:end,5)'  shtc(:,4)' zeros(1,nLnbr)   -100.*ones(1,nLnbr)  zeros(1,2*nLnbr+nLnbr)  -(1.1^2-0.9^2).*ones(1,nLnbr)   -nb*2.*ones(1,nLnbr)  zeros(1,2*nLnbr), zeros(1,nLnbr) ];
ub =[100.*ones(1,3*nLnbr) (bus(:,10).^2)' gen(2:end,4)'  shtc(:,3)'  100.*ones(1,2*nLnbr) nb.*ones(1,2*nLnbr+nLnbr) (1.1^2-0.9^2).*ones(1,nLnbr) nb*2.*ones(1,nLnbr) ones(1,2*nLnbr) ones(1,nLnbr) ];
...
prob.c = [obj_1 zeros(1,nLnbr*2+nb+nshtc+npv+2*nLnbr+2*nLnbr+nLnbr+nLnbr+4*nLnbr) ];
prob.a = sparse(A);
prob.blc = sparse(rl);
prob.buc = sparse(ru);
prob.blx = lb;
prob.bux = ub;
prob.ints.sub=[3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+3*nLnbr+1:3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+4*nLnbr];   % u is a set of integer variables
...
u = X_Opt(3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+3*nLnbr+1:3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+4*nLnbr,1);   % u is a set of 0-1 integer variable
beta = X_Opt(3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+nLnbr+1:3*nLnbr+nb+npv+nshtc+2*nLnbr+2*nLnbr+nLnbr+nLnbr+3*nLnbr,1);   % u is a set of 0-1 integer variable
